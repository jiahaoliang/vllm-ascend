...
def test_make_layerwise_block_key_uses_model_block_and_rank():
    ...
    assert make_layerwise_block_key("model", "req_lastblock", 3) == "model@req_lastblock@3"
...
def test_make_layerwise_block_key_includes_group_for_multi_group_objects():
    ...
    assert make_layerwise_block_key("model", "req_lastblock", 1, group_id=5) == "model@5@req_lastblock@1"
